pro optimize_rotation_center, slice, vol, center, entropy
   ...
   r = reconstruct_slice(slice, vol, center=center[ncenter/2], r2)
   ...
   for i=0, ncenter-1 do begin
      r = reconstruct_slice(slice, vol, center=center[i], r2)
